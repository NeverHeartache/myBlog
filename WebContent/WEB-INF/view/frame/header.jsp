			...
			<div class="collapse navbar-collapse justify-content-end">
				<div class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img
						src="${webRoot }/images/plant.jpg" class="img-circle"
						alt="parson-img" style="width: 24px; height: 24px;"> <i
						class="icon-submenu fa fa-angle-down"></i>
					</a>
					<div class="navbar-right dropdown-menu" aria-labelledby=""
						style="padding: 0; margin-right: 70px;">
						<a class="dropdown-item" href="${webRoot }/api/userLoginPage">登录</a>
						<a class="dropdown-item" href="#">个人中心</a> <a
							class="dropdown-item" href="${webRoot }/api/logout">退出</a>
					</div>
				</div>
			</div>
		</div>
